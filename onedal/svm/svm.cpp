...
void init_model(py::module_& m) {
    ...
    if constexpr (is_classification || is_nu_classification) {
        ...
        auto class_1_setter = &model_t::template set_first_class_label<>;
        auto class_2_setter = &model_t::template set_second_class_label<>;

        cls.def_property("first_class_label", &model_t::get_first_class_label, class_1_setter);
        cls.def_property("second_class_label", &model_t::get_second_class_label, class_2_setter);
    }
}
